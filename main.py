...
LANGS = {
    ...
    "fr": {
        "ui_title": "Complétez les tâches pour débloquer 🔓",
        ...
        "hi": "{name} — 👋 Bienvenue !\nVoici ta mission. Termine les tâches ci-dessous pour que ta demande d’accès au groupe/chaîne soit approuvée instantanément 👇",
        "help": "Commandes:\n/menu, /help, /about, /tip, /lang, /progress, /top, /daily\nAdmin: /broadcast, /blast, /setdaily, /senddaily, /drop, /poll, /results",
    ...
    "ru": {
        "ui_title": "Выполни задания, чтобы разблокировать 🔓",
        ...
        "hi": "{name} — 👋 Добро пожаловать!\nТвоя миссия: выполни задания ниже, и твоя заявка на вступление в группу/канал будет одобрена мгновенно 👇",
    ...
    "pg": {  # Nigerian Pidgin
        ...
        "hi": "{name} — 👋 Welcome!\nNa your mission be this. Run the tasks wey dey below make your request to join the group/channel go approve instantly 👇",
